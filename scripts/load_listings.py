...
for x in us_states:
    ...
    for country, link in all_listings.items():
        ...
        with open("another_four6.json", "w+") as outfile:
        ...
        data_frame.to_csv('data5.csv', mode='a', header=False)

        with open('data5.csv', encoding='utf8') as file:
